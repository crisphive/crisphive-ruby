  ...
  class JobRequestMoveCommitReq
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Crisphive::JobRequestMoveCommitReq` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Crisphive::JobRequestMoveCommitReq`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'expected_member_ids')
        if (value = attributes[:'expected_member_ids']).is_a?(Array)
          self.expected_member_ids = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@expected_version.nil? && @expected_version < 0
        invalid_properties.push('invalid value for "expected_version", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@expected_version.nil? && @expected_version < 0
    ...
    def expected_version=(expected_version)
      if expected_version.nil?
        fail ArgumentError, 'expected_version cannot be nil'
      end

      if expected_version < 0
        fail ArgumentError, 'invalid value for "expected_version", must be greater than or equal to 0.'
      end
