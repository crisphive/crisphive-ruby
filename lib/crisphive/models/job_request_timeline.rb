...
module Crisphive
  class JobRequestTimeline
    # Status key the job is currently in.
    attr_accessor :current_status_key
    ...
    def self.openapi_types
      {
        ...
        :'events' => :'Array<JobRequestTimelineEvent>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Crisphive::JobRequestTimeline` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Crisphive::JobRequestTimeline`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'current_status_key')
        self.current_status_key = attributes[:'current_status_key']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          current_status_key == o.current_status_key &&
          events == o.events &&
    ...
    def hash
      [current_status_key, events, status_version, workflow_id, workflow_name].hash
    end
