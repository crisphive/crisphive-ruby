...
module Crisphive
  class JobRequestEmergencyCommitRequest
    ...
    attr_accessor :emergency_expected_version
    ...
    attr_accessor :expected_move_ids
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Crisphive::JobRequestEmergencyCommitRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Crisphive::JobRequestEmergencyCommitRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'emergency_expected_version')
        self.emergency_expected_version = attributes[:'emergency_expected_version']
      end
      ...
      if attributes.key?(:'expected_move_ids')
        if (value = attributes[:'expected_move_ids']).is_a?(Array)
          self.expected_move_ids = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @technician_id.nil?
        invalid_properties.push('invalid value for "technician_id", technician_id cannot be nil.')
      end
    ...
    def valid?
      ...
      displacement_mode_validator = EnumAttributeValidator.new('String', ["reschedule", "reassign"])
      return false unless displacement_mode_validator.valid?(@displacement_mode)
      ...
      return false if @technician_id.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] displacement_mode Object to be assigned
    def displacement_mode=(displacement_mode)
      validator = EnumAttributeValidator.new('String', ["reschedule", "reassign"])
      unless validator.valid?(displacement_mode)
        fail ArgumentError, "invalid value for \"displacement_mode\", must be one of #{validator.allowable_values}."
      end
      @displacement_mode = displacement_mode
    end
