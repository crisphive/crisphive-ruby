...
module Crisphive
  class JobRequestRescheduleMove
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Crisphive::JobRequestRescheduleMove` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Crisphive::JobRequestRescheduleMove`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'from_end')
        self.from_end = attributes[:'from_end']
      end

      if attributes.key?(:'from_start')
        self.from_start = attributes[:'from_start']
      end
      ...
      if attributes.key?(:'to_end')
        self.to_end = attributes[:'to_end']
      end

      if attributes.key?(:'to_start')
        self.to_start = attributes[:'to_start']
      end
    end
    ...
    def hash
      [customer_name, from_end, from_start, job_id, priority, short_code, to_end, to_start].hash
    end
